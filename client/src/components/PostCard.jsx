...
const PostCard = ({ post, user, deletePost, likePost }) => {
  ...
  return (
    <div className="wb-2 bg-gray-200 rounded-xl p-5">
      <div className="flex gap-3 items-center mb-2 p-1 border-b border-gray-300">
        ...
        <div className="w-full flex justify-between">
          ...
          <span className="text-ascent-2">
            {moment(post?.createdAt ?? "24-06-2024").fromNow()}
          </span>
        </div>
      </div>
      ...
      <div>
        <p className="text-ascent-2">
          ...
          {post?.description?.length > 301 &&
            (showAll === post?._id ? (
              <span
                className="text-blue-600 ml-2 font-medium cursor-pointer"
              ...
              <div className="w-full py-2" key={comment?._id}>
                <div className="flex flex-col gap-1 mb-1">
                  <div className="flex flex-row gap-14">
                    ...
                    <div className="ml-12 bg-gray-300 rounded-r-xl px-4 py-1 flex flex-col">
                      <p className="text-sm">{comment?.comment}</p>

                      <div className="mt-2 flex gap-6">
                        <p className="flex gap-2 items-center text-sm cursor-pointer">
                          {" "}
...
<div className="py-2 px-8 mt-6">
                  ...
                  <div className="border-b border-gray-300">
                    ...
                    <span className="text-ascent-2 text-sm ">
                      {moment(comment?.createdAt ?? "24-06-2024").fromNow()}
                    </span>
                  </div>
                </div>
              </div>
